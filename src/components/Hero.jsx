                ...
                <div className="hero-layout">
                    ...
                    <div className="reveal hero-main">
                        ...
                        <div className="hero-btns">
                            ...
                            <a
                                href="https://drive.google.com/file/d/1JOCMnJEFnZ7u_hBJi2G-ORgKlm1dQKU8/view?usp=sharing"
                                target="_blank"
                            ...
                            <a href="https://github.com/pragneshkalotara" target="_blank" className="btn-secondary" style={{ textDecoration: 'none' }}>
