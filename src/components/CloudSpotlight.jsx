            ...
            <div className="container">
                <div className="reveal cloud-card">
                    <div className="cloud-header">
                        ...
                        <div className="cloud-title">Cloud &amp; Search Expertise <span className="cloud-sub">— Apotec (Current Role)</span></div>
                    </div>
                    <div className="cloud-desc">At Apotec, deepening expertise in enterprise-grade AWS-native architecture and distributed search systems at scale.</div>
